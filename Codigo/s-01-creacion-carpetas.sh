...
echo "Creando directorio /u01/app/oracle/oradata/CHJOPROY/disk_2/"
mkdir -p /u01/app/oracle/oradata/CHJOPROY/disk_2/
...
#echo "Creando directorio /u05/oradata/CHJOPROY/disk_2/"
#mkdir -p /u05/oradata/CHJOPROY/disk_2/
